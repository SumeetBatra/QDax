# https://colab.research.google.com/github/adaptive-intelligent-robotics/QDax/blob/main/examples/pgame.ipynb#scrollTo=mQmwRiE-a8fO
import os
import time
import functools
import argparse
...
def parse_args():
    ...
    parser.add_argument('--wandb_group', type=str, default='QDPG')
    ...
    parser.add_argument('--quality_pg_batch_size', type=int, default=34)
    parser.add_argument('--diversity_pg_batch_size', type=int, default=33)
    parser.add_argument('--ga_batch_size', type=int, default=33)
    ...
    parser.add_argument('--archive_acceptance_threshold', type=float, default=0.1)
    parser.add_argument('--archive_max_size', type=int, default=10000)

    parser.add_argument('--num_nearest_neighb', type=int, default=5)
    parser.add_argument('--novelty_scaling_ratio', type=int, default=1.0)
    ...
    cfg.env_batch_size = cfg.quality_pg_batch_size + cfg.diversity_pg_batch_size + cfg.ga_batch_size
    return cfg
...
def run():
    ...
    qpg_emitter_config = QualityPGConfig(
        env_batch_size=cfg.quality_pg_batch_size,
    ...
    dpg_emitter_config = DiversityPGConfig(
        env_batch_size=cfg.diversity_pg_batch_size,
        batch_size=cfg.transitions_batch_size,
        critic_hidden_layer_size=cfg.critic_hidden_layer_size,
        critic_learning_rate=cfg.critic_learning_rate,
        policy_learning_rate=cfg.policy_learning_rate,
        ...
        num_pg_training_steps=cfg.num_pg_training_steps,
        policy_delay=cfg.policy_delay,
        archive_acceptance_threshold=cfg.archive_acceptance_threshold,
    ...
    qdpg_emitter_config = QDPGEmitterConfig(
        ...
        ga_batch_size=cfg.ga_batch_size,
    )
    ...
    score_novelty = jax.jit(
        functools.partial(
            ...
            num_nearest_neighb=cfg.num_nearest_neighb,
            scaling_ratio=cfg.novelty_scaling_ratio,
        )
    )
